  ...
  return (
    <Container>
      <div className="leftContainer">
        <h1 className="fLogo">Shop.</h1>
        <p className="fDesc">
          Shop from the comfort of your home and browse our wide variety of
          clothing, footwear, and accessories. Whether you're searching for a
          timeless dress, the perfect pair of jeans, or that on-trend top, we
      ...
      <div className="rightContainer">
        ...
        <div className="contactItem">
          <MailOutline style={{ marginRight: "10px" }} /> naya@gmail.com
        </div>
